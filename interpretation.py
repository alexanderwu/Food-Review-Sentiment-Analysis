...
class Interpretation(object):
    ...
    def __init__(self, clf, text=""):
        ...
        self.compact_interpret = self.interpret_compact(self.wt_text)
        self.expanded_interpret = self.interpret_expanded(self.wt_text)
    ...
    def interpret_compact(self, text):
        ...
        valid_text = list(self.valid_ngrams(self.wt_text))
        v_text = [" "] + valid_text
    ...
    def interpret_expanded(self, text):
        ...
        valid_text = self.valid_ngrams(self.wt_text)
